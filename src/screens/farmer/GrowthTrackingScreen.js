            ...
            {!loadingDetails && selectedPlotDetails && selectedPlotDetails.plot && (() => {
              ...
              <ScrollView style={styles.plotDetailsCard} nestedScrollEnabled={true}>
                ...
                {(() => {
                  ...
                  // Sample data for demonstration when no real analysis exists
                  const samplePestData = {
                    "health_status": "healthy",
                    "risk_level": "low",
                    "confidence": 0.85,
                    "crop_type": selectedPlotDetails.plot.crop_type || "unknown",
                    "growth_stage": {
                      "stage": "vegetative",
                    ...
                    "predictions": [],
                    "immediate_actions": [],
                    "_note": "This is sample data. Upload crop images to get real AI analysis."
                  };
                  
                  const displayData = pestAnalysis || samplePestData;
                        ...
                        <View style={styles.jsonDashboard}>
                          {!isRealData && (
                            <View style={styles.sampleDataBanner}>
                              ...
                              <Text style={styles.sampleDataText}>
                                Sample Data - Upload crop images for real AI analysis
                              </Text>
                            </View>
                          )}
                          <View style={styles.jsonHeader}>
                            ...
                            <Text style={styles.jsonHeaderText}>
                              Pest & Disease Analysis - {isRealData ? 'REAL' : 'SAMPLE'} JSON Data
                            </Text>
                          </View>
                ...
                {(() => {
                  ...
                  // Sample soil data for demonstration
                  const sampleSoilData = {
                    ...
                    "_note": "This is sample data. Upload soil images to get real AI analysis."
                  };
                  
                  const displayData = soilAnalysis || sampleSoilData;
                        ...
                        <View style={styles.jsonDashboard}>
                          {!isRealData && (
                            <View style={styles.sampleDataBanner}>
                              <MaterialCommunityIcons name="information" size={20} color="#FF9800" />
                              <Text style={styles.sampleDataText}>
                                Sample Data - Upload soil images for real AI analysis
                              </Text>
                            </View>
                          )}
                          <View style={styles.jsonHeader}>
                            <MaterialCommunityIcons name="code-json" size={24} color="#4CAF50" />
                            <Text style={styles.jsonHeaderText}>
                              Soil Health Analysis - {isRealData ? 'REAL' : 'SAMPLE'} JSON Data
                            </Text>
                          </View>
                          <View style={styles.jsonScrollContainer}>
                            <ScrollView 
